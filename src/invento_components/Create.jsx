...
const Create = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // call an api endpoint that collects the data and give it the data
    // update your state to reflect the new product
    addProduct({ productname: data.productname, qty: Number(data.qty) });
